...
public final class TweakStore {
	...
	public init(tweaks: [TweakClusterType], storeName: String = "Tweaks", storeDirectory: URL? = nil, enabled: Bool) {
		self.persistence = TweakPersistency(identifier: storeName, directory: storeDirectory)
